...
public class ParticipantLogger {
	 ...
	 * @throws IOException
	 */
	public static void initLogger(int loggerServerPort, int processId, int timeout) throws Exception {
		if (logger == null)
	...
	private ParticipantLogger(int loggerServerPort, int processId, int timeout) throws Exception {
